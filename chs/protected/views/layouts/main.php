...
<div class="container" id="page">
    ...
    <div id="mainmenu">
        <?php $this->widget('zii.widgets.CMenu',array(
            'items'=>array(
                array('label'=>'Home', 'url'=>array('/servicecall/freesearch')),
                array('label'=>'ServiceCall', 'url'=>array('/servicecall/admin')),
                array('label'=>'Print Jobs', 'url'=>array('/enggdiary/changeEngineer&month='.date('m').'&year='.date('y'))),
                array('label'=>'Manual Diary', 'url'=>array('/enggdiary/manuallyappointmentbooking')),
