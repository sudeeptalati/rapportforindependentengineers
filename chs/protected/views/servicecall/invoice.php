...
<table style="width:100%;    ">
    <tr>
        <td align="left">
            <h3>   Invoice No#</h3>
            <h1><?php echo $model->service_reference_number; ?></h1>
            <!--
        ...
        <td>
        <!--
            <h3 style="text-align: center;">Visit Date</h3>
            <?php
			...
			<small><b>Country</b></small>
			 ...
			 -->
                    ...
                    <td style='text-align:right;'>
                        ...
                        <br>
                        <?php
                        $line1 = $model->contract->mainContactDetails->address_line_1;
                        $line2 = $model->contract->mainContactDetails->address_line_2;
                        $line3 = $model->contract->mainContactDetails->address_line_3;
                        $town =  $model->contract->mainContactDetails->town;
                        $postcode = $model->contract->mainContactDetails->postcode;
...
<table style="width:100%">
    <tr><td colspan="4"><h3><i>Fault Reported Details</h3></i></td></tr>
    <tr>
...
// 		echo "Total = ".$total = $data->total_price;
                ...
                <tr>
                    <td colspan="6" style="border-left:1px solid black;border-right:1px solid black;border-top:1px solid black;  text-align:right;">Subtotal</td>
