...
?>
						...
						<table>
							<tr>
								<td><h4>
										...
										<small id="sms-charecter-count">
											Character Count <?php echo strlen($model->sms_template); ?>
										</small>
	...
	<script>
		...
		////SMS Charecter count//////
		$( "#NotificationRules_sms_template" ).keyup(function() {

			charecter_count=$('#NotificationRules_sms_template').val().length;
			console.log( "Handler for .keyup() called."+charecter_count );
			no_of_sms=charecter_count/160;
			no_of_sms=Math.ceil(no_of_sms);
			document.getElementById("sms-charecter-count").innerHTML="Character Count "+charecter_count+"<br>"+no_of_sms+" sms charges";
