...
<!-- CODE FOR MASTER TABLE TO CHANGE COLOR END -->
	...
	<table style="width:400px; margin:10px;">
	<tr><td colspan="3">
	<h2 style="margin-bottom:0.01px;color:#555;"><label>Product Details</label></h2></td></tr>
	...
	<tr>
		<td>
			...
			<br>
			<small><b><a href="index.php?r=brand/admin"  target="_blank">Click here to acivate More Brands</a> </b></small>
...
<tr><td style="background-color: #FFD8B3; border-radius: 15px; vertical-align: top;">
