<div class="form">
    ...
    $model->notification_rule_id=$notification_rule_id;

    $form=$this->beginWidget('CActiveForm', array(
        'id'=>'notification-contact-form',
        'enableAjaxValidation'=>false,
        'action' => array( '/notificationContact/create' ), // change depending on your project
    )); ?>
    ...
    <div class="row buttons">
        ...
        <?php
        /*
        echo CHtml::ajaxSubmitButton('Save',CHtml::normalizeUrl(array('notificationContact/create','render'=>true)),array('success'=>'js: function(data) {
