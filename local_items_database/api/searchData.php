		...
		try
		{
			...
			if($rows)
			{
				...
				?>
					...
					<a href='../chs/index.php?r=servicecall/update&id=<?php echo $service_id;?>&cloud_id=0&master_id=<?php echo $data['id'];?>#freesearch-Form'>
			...
			<tr>
				...
				<table>
					...
					<tr>
						<td>
						<b>Unit Price: </b></td><td><input type="text" name="unit_price" size="3"  style="width: 32px;">
						<b>&nbsp;&nbsp;&nbsp;&nbsp;Qty</b>&nbsp;<input onkeyup="showAddNewSpareSubmitButton()" type="text" name="quantity" size="3" style="width: 32px;" ><small style="color:red">(required)</small>
						</td>
					</tr>
					<tr>
						<td colspan="4">
