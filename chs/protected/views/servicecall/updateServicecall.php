				...
				<?php 
					if($model->spares_used_status_id == 1)
					{
						...
						<?php 
								...
								echo $form->textField($model,'total_cost', array('size'=>'10' , 'style'=>'text-align:right'));
						?></td>
						...
						<td  colspan="2" style="text-align:right;"><?php echo $form->textField($model,'vat_on_total', array('disabled'=>'disabled', 'size'=>'10' , 'style'=>'text-align:right')); ?></td>
						...
						<?php 
							...
							echo $form->textField($model,'net_cost', array('size'=>'10' , 'style'=>'text-align:right'));
						?></td>
...
if (!empty($_GET['cloud_id']) || !empty($_GET['master_id']))
{
	...
	<tr>
		<td><b> <?php echo $part_number;?>&nbsp;&nbsp;<?php echo $name;?></b></td> 
	
		<td style="text-align:left;">
			<input type="text" name="quantity" size="3" style='width:50px;'> 
		</td>
		<td>	
			<input type="text" name="unit_price" size="3" value='<?php echo $sale_price; ?>' style='width:50px;'> 
		</td>
	</tr>
	<tr>
		<td colspan="2">
...
<!-- ***** END OF CODE TO GET THE FREES SEARCH OF MASTER DATABASE ENDS **** -->
			...
			<td>
				...
				<?php echo $form->labelEx($model,'comments'); ?><br><small>(not visible on call sheet)</small><br>
