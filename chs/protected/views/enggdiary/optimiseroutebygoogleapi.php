...
<?php
$current_date = date('d-m-Y', $selected_date_int);
$print_all_jobs_link = "index.php?r=servicecall/PrintAllJobsForDay&engg_id=" . $engineer_id . "&date=" . $current_date;
?>
...
<table>
    ...
    <tr>
        <td>
            <h1 title="Print all these jobs">
                <a target="_blank" href="<?php echo $print_all_jobs_link ?>">
                    <i class="fa fa-print" aria-hidden="true"></i>
                </a>
            </h1>
        </td>
        <td>
            <h4><?php echo $engineer->fullname; ?><h4>
        </td>
