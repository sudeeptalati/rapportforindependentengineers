...
?>
	...
	<table>
	<tr>
		<th colspan='3'><h3>Service Ref. No.# <?php echo $model->servicecall->service_reference_number;?></h3></th>
	...
	<td style="vertical-align:top;">
		...
		<td>
			<h3>Appointment</h3>
			<h4> <?php echo  date('d-M-Y h:i:s A', $model->visit_start_date); ?></h4>
		...
		<td colspan="2">
			<h3>Notes</h3>
				...
				<?php echo CHtml::textArea('appointment_notes',$model->notes,array('placeholder'=>'Additional Notes for call',
