...
class Product extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('brand_id, product_type_id', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'enr_number' => 'Color',
			'fnr_number' => 'Appliance Age (in months)',
			'discontinued' => 'Write off',
	...
	{
		ModelNumbers::model()->savemodelnumber($this->model_number,$this->brand_id,$this->product_type_id);

		
	}///end of function aftersave
