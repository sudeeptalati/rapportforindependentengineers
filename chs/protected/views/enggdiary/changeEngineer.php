...
$action_hidden_f='<input type="hidden" name="r" value="enggdiary/changeEngineer" />';
...
/* "next month" control */
$next_month_link = '<a href="index.php?r=enggdiary/changeEngineer&'.$add_params.'&amp;month='.($month != 12 ? $month + 1 : 1).'&amp;year='.($month != 12 ? $year : $year + 1).'" class="control">Next Month >></a>';

/* "previous month" control */
$previous_month_link = '<a href="index.php?r=enggdiary/changeEngineer&'.$add_params.'&amp;month='.($month != 1 ? $month - 1 : 12).'&amp;year='.($month != 1 ? $year : $year - 1).'" class="control"><< 	Previous Month</a>';
...
if($engg_id)
{
	...
	echo '<h2>'.$model->engineer->fullname.'</h2>';
	echo $draw;
}
