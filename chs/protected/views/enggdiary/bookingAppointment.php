...
//					'(should probably update your database)');
	...
	*/				
	...
	function createNewDiaryEntry(event_date, engg_id, service_id)
	{
		...
		var urlToCreate = baseUrl+'/index.php?r=api/createNewDiaryEntry&start_date='+event_date+'&engg_id='+engg_id+'&service_id='+service_id+'&notes='+notes;
		//alert(urlToCreate);
