...
");
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <br>
                    <small>Short name is like nick name with which you can quickly remember which contract it is.</small>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo $form->labelEx($model, 'labour_warranty_months_duration'); ?>
                    <small>Years &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Months</small>
                    <br>
                ...
                <td>
                    <?php echo $form->labelEx($model, 'parts_warranty_months_duration'); ?>
                    <small>Years &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Months</small>
                    <br>
            ...
            <tr>
                ...
                <td>
                    <?php echo $form->labelEx($model, 'max_spend_limit_without_authorisation'); ?>
                    <?php echo $form->textField($model, 'max_spend_limit_without_authorisation', array('rows' => 6, 'cols' => 50)); ?>
                    <?php echo $form->error($model, 'max_spend_limit_without_authorisation'); ?>
                </td>
                <td>
    ...
    <div class="contentbox" style="background-color: #ADEBAD;">
        <table style="width:700px; margin:10px; background-color: #ADEBAD;  border-radius: 15px;padding:15px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    ?>
                    <?php echo $form->labelEx($contactDetailsModel, 'postcode', array('size' => 3, 'maxlength' => 5, 'style' => 'width:2.5em;display: inline')); ?>
                    ...
                    <span style="cursor: pointer" class="fa fa-globe fa-2x" aria-hidden="true" href=""
                          onclick="js:getlatlongofpostcode()" title="Get Latitudes & Longitudes of Postcode"> </span>
    ...
    <div class="contentbox" style="background-color: #F3B6B7;">
    ...
    <div class="contentbox" style="background-color: #d5f3b6;">
        <h5>(For remote call Booking. Please obtain from your Contract Provider)</h5>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo $form->textField($model, 'api_key', array('style' =>'width:90%')); ?>
                    <?php echo $form->error($model, 'api_key'); ?>
                    <br>

                </td>
                <td>
                    <?php echo $form->labelEx($model, 'portal_url'); ?>
                    <?php echo $form->textField($model, 'portal_url', array('style' =>'width:90%')); ?>
                    <?php echo $form->error($model, 'portal_url'); ?>
                </td>
            ...
            <tr>
                <td>
                    <?php echo $form->labelEx($model, 'portal_login_email'); ?>
                    <?php echo $form->textField($model, 'portal_login_email', array('style' =>'width:90%')); ?>
                    <?php echo $form->error($model, 'portal_login_email'); ?>
                </td>
                <td>
                    <?php echo $form->labelEx($model, 'portal_encrypt_pass'); ?>
                    <?php echo $form->textField($model, 'portal_encrypt_pass', array('style' =>'width:90%')); ?>
                    <?php echo $form->error($model, 'portal_encrypt_pass'); ?>
                </td>
            </tr>
            <tr>
                <td colspan="2">
